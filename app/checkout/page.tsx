...
const CheckoutPage = () => {
  ...
  const makePurchase = async () => {
    if (
      ...
      const response = fetch("https://ngo-server-production.up.railway.app/api/orders", {
        method: "POST",
        headers: {
  ...
  const addOrderProduct = async (
    ...
    const response = await fetch("https://ngo-server-production.up.railway.app/api/order-product", {
      method: "POST", // or 'PUT'
      headers: {
        "Content-Type": "application/json",
      },
