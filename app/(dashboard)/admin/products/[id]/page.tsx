...
const DashboardProductDetails = ({
  ...
  const deleteProduct = async () => {
    ...
    fetch(`https://ngo-server-production.up.railway.app/api/products/${id}`, requestOptions)
      .then((response) => {
  ...
  const uploadFile = async (file: any) => {
    ...
    try {
      const response = await fetch("https://ngo-server-production.up.railway.app/api/main-image", {
        method: "POST",
        body: formData,
      });
  ...
  const fetchProductData = async () => {
    fetch(`https://ngo-server-production.up.railway.app/api/products/${id}`)
      .then((res) => {
        return res.json();
      })
      .then((data) => {
    ...
    const imagesData = await fetch(`https://ngo-server-production.up.railway.app/api/images/${id}`, {
      cache: "no-store",
    });
